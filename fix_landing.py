...
# Find the first Owner Access Modal
idx1 = content.find("{/* Owner Access Modal */}")

# Remove everything after it, then append just one copy of the Owner Access Modal and the closing tags
if idx1 != -1:
    modal_code = """      {/* Owner Access Modal */}
...
"""
    content = content[:idx1] + modal_code
