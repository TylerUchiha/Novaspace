...
content = content.replace("const [userRole, setUserRole] = useState<'customer' | 'employee' | 'admin'>('customer');", "const [userRole, setUserRole] = useState<'customer' | 'employee' | 'admin'>('customer');\n" + state_code)
